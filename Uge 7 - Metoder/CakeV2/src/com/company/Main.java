...
public class Main {
    ...
    */
        ...
        FoodSort eggX = new FoodSort(137.0, 12.0, 1.3, 0, 2.8);
        FoodSort vanillaX = new FoodSort(195.0, 4.6, 17.0, 10.7, 5.9);
        FoodSort sugarX = new FoodSort(400.0, 0.0, 100.0, 100.0, 0.0);
